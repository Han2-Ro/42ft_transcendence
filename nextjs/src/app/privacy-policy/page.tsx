export default function Page() {
  return (
    <main className="p-4">
      ...
      <h2>Introduction</h2>
      <p>NAME (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) operates URL (the &quot;Service&quot;). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our Service. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the Service.</p>
      ...
      <p>We collect this information when you voluntarily provide it to us, when you use our Service, or through automated technologies.</p>
      ...
      <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights under the General Data Protection Regulation (GDPR). NAME aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your personal data.</p>
      ...
      <p>If you wish to exercise any of these rights, please contact us at EMAIL. We will respond to your request within 30 days.</p>
